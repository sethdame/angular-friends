...
// Step 4, bullet point 1
$scope.searchTerm = friend.input;
// Step 5, bullet point 3
$scope.searchTerm = friend.location;

// Step 6
var attOne = ;
var attTwo = true;

"angular.element($0).scope().friends"
"angular.element($0).scope().friends.length"
